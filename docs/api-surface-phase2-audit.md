...
Baseline: `origin/main` at PR #33 (`076173b`). No checked-in `.specify/` run artifacts or skill
drafts were present, so evidence is from source, tests, README, templates, and deploy docs.
