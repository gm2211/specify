...
export const COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: '--human', type: 'boolean', required: false, description: 'Open a headed browser for human recording (--from live only)' },
    ],
    modes: [
      {
        name: 'from_live',
        description: 'Navigate to URL, record traffic and screenshots (passive, single page). If CLAUDE_CODE_OAUTH_TOKEN is set, runs as autonomous agent.',
