...
export const COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: '--formal-manifest', type: 'string', required: false, description: 'Formal mode: project-owned JSON manifest of model files, properties, negative controls and seeded trace declarations' },
      { name: '--quint-binary', type: 'string', required: false, description: 'Formal mode: installed Quint executable (default quint on PATH)' },
      { name: '--generate-traces', type: 'boolean', required: false, description: 'Formal mode: generate seeded ITF corpus instead of proof verdicts; does not approve models for browser replay' },
