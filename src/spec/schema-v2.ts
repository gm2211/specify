/**
 * src/spec/schema-v2.ts — JSON Schema for v2 behavioral spec format
 *
 * Much simpler than v1: no matchers, no selectors, no step sequences.
 * Areas group behaviors; behaviors are plain-language claims.
 */

export const specSchemaV2 = {
  $schema: 'http://json-schema.org/draft-07/schema#',
  title: 'Specify Spec v2',
